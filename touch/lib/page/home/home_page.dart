...
import 'package:touch/page/search/search_page.dart';
import 'package:touch/util/app_constant.dart';
import 'package:touch/util/app_widget.dart';
import 'package:touch/util/system_overlay.dart';
import 'package:touch/widget/homepage/bottom_sheet.dart';
import 'package:touch/widget/homepage/search_box.dart';
import 'package:touch/widget/homepage/tdk_cover.dart';
import 'package:touch/widget/homepage/home_page_list_view.dart';
  ...
  Widget _renderItem(StateSetter setState) => Column(
        children: <Widget>[
          ...
          AppBottomSheetWidgets.selectCategory(
              _horizontalCategoryItem(id: 0, title: AppConstant.contact), _horizontalCategoryItem(id: 1, title: AppConstant.suggestions))
        ],
      );
