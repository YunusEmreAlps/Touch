...
class AppBottomSheetWidgets {
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: MaterialButton(
                ...
                onPressed: () {
                   // _launchURL('https://Touchpinfo.netlify.app');
                },
              ),
            ),
            Padding(
              ...
              child: MaterialButton(
                ...
                shape: RoundedRectangleBorder(
                    borderRadius: new BorderRadius.circular(8)),
                child: Text(AppConstant.webappLink,
                    style: TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.bold,
                        color: AppConstant.colorHeading)),
                onPressed: () {
                  //  _launchURL('http:Touchp.netlify.com/');
                },
              ),
            ),
          ],
  ...
  static _sendMail() async {
    final String mail = 'mailto:info@Touch.com.tr';
  ...
  static _launchURL(String url) async {
    // final String url = 'http:Touchp.netlify.com/';
